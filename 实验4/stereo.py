...
if __name__ == '__main__':
    # 读取MiddleBurry数据集的图片
    iml = cv2.imread('./Backpack-perfect/im0.png', 1)  # 左图
    imr = cv2.imread('./Backpack-perfect/im1.png', 1)  # 右图
    ...
    rgbdImage = o3d.geometry.RGBDImage.create_from_color_and_depth(color=colorImage, depth=depthImage,
                                                                   depth_scale=1000.0,
